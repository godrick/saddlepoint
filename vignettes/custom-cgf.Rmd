...
- `ineq_constraint(tvec, param)` returning a numeric vector of constraints $g(t,\theta)$ with feasibility defined by $g \le 0$,
- `analytic_tvec_hat(x,param)` if you can solve $K_1(\hat t;\theta)=x$ in closed form
