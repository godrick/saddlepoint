...
// Value extractor for RTMB AD objects.
// Based on RTMB internal helper patterns (GPL-2|GPL-3).
// // from https://github.com/kaskr/RTMB/blob/master/RTMB/src/RTMB_tape.cpp
// [[Rcpp::export]]
